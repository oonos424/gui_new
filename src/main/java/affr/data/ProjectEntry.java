 ...
 *
 * <p>This is a lightweight browser-level snapshot of a project — it carries only what is needed
 * to render a card in the File-browser view. Loading the full project domain object (calculations,
